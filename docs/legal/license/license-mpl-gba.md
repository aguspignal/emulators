This software is partly licensed under the Mozilla Public License 2.0. As per the terms of the MPL 2.0, we provide access to the complete source code for this software.
